...
sed -i 's/value: 10.10.10.60/value: 192.168.200.3/g' /root/nfs/deployment.yaml
sed -i 's/value: !ifs!kubernetes/value: !data!volumes!v1/g' /root/nfs/deployment.yaml
sed -i 's/server: 10.10.10.60/server: 192.168.200.3/g' /root/nfs/deployment.yaml
sed -i 's/path: !ifs!kubernetes/path: !data!volumes!v1/g' /root/nfs/deployment.yaml
